...
RESOURCES += src/qt/nuwacoin.qrc src/qt/nuwacoin_locale.qrc

TRANSLATIONS += src/qt/locale/nuwacoin_bg.ts \
                src/qt/locale/nuwacoin_de.ts \
                src/qt/locale/nuwacoin_en.ts \
                src/qt/locale/nuwacoin_es.ts \
                src/qt/locale/nuwacoin_fi.ts \
                src/qt/locale/nuwacoin_fr.ts \
                src/qt/locale/nuwacoin_it.ts \
                src/qt/locale/nuwacoin_ja.ts \
                src/qt/locale/nuwacoin_pl.ts \
                src/qt/locale/nuwacoin_pt.ts \
                src/qt/locale/nuwacoin_ru.ts \
                src/qt/locale/nuwacoin_sk.ts \
                src/qt/locale/nuwacoin_sv.ts \
                src/qt/locale/nuwacoin_vi.ts \
                src/qt/locale/nuwacoin_zh_CN.ts \
                src/qt/locale/nuwacoin_zh_TW.ts
