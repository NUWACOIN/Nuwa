...
This document provides guidelines for internationalization of the NuwaCoin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to NuwaCoin network</source>
        <translation>
            <numerusform>%n active connection to NuwaCoin network</numerusform>
            <numerusform>%n active connections to NuwaCoin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nuwacoin_en.ts` remains unchanged.
