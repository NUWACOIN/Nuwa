...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NuwaCoin nuwacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nuwacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nuwacoin transaction") + "\n" +
                               "  nuwacoin-tx [options] -create [commands]   " + _("Create hex-encoded nuwacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nuwacoin transaction
