...
#include "qt/nuwacoin/sendcustomfeedialog.h"
#include "qt/nuwacoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(NuwaCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &NuwaCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
