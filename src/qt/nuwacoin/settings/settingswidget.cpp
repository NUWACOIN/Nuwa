...
#include "qt/nuwacoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(NuwaCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &NuwaCoinGUI::openFAQ);
