...
#include "qt/nuwacoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/nuwacoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(NuwaCoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableNAC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableNAC,
    ...
    connect(ui->pushButton_UnspendableNAC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableNAC);});
    ...
    if (parent)
        connect(parent, &NuwaCoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
