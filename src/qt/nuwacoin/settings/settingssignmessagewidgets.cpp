...
#include "qt/nuwacoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(NuwaCoinGUI* _window, QWidget *parent) :
