...
#include "qt/nuwacoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(NuwaCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("NuwaCoin_tx_csv_export(*.csv)") : tr("NuwaCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
