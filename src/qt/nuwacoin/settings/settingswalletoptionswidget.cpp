...
#include "qt/nuwacoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/nuwacoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(NuwaCoinGUI* _window, QWidget *parent) :
