...
#include "qt/nuwacoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/nuwacoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(NuwaCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the N\u00FCwa Coin RPC console.") + "<br>" +
