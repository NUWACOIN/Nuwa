...
#include "qt/nuwacoin/settings/settingsnetworkwidget.h"
#include "qt/nuwacoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/nuwacoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NuwaCoinGUI* _window, QWidget *parent) :
