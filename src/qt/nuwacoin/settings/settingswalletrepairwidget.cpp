...
#include "qt/nuwacoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/nuwacoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NuwaCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NuwaCoinGUI::handleRestart()
