...
#include "qt/nuwacoin/navmenuwidget.h"
#include "qt/nuwacoin/topbar.h"
#include "qt/nuwacoin/dashboardwidget.h"
#include "qt/nuwacoin/send.h"
#include "qt/nuwacoin/receivewidget.h"
#include "qt/nuwacoin/addresseswidget.h"
#include "qt/nuwacoin/coldstakingwidget.h"
#include "qt/nuwacoin/masternodeswidget.h"
#include "qt/nuwacoin/snackbar.h"
#include "qt/nuwacoin/settings/settingswidget.h"
...
/**
  NuwaCoin GUI main class. This class represents the main window of the NuwaCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NuwaCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NuwaCoinGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~NuwaCoinGUI();
