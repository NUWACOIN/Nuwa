...
#include "qt/nuwacoin/forms/ui_coldstakingwidget.h"
#include "qt/nuwacoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/nuwacoin/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(NuwaCoinGUI* parent) :
    PWidget(parent),
