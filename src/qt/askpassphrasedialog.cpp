...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            NuwaCoinGUI* window = static_cast<NuwaCoinGUI*>(parentWidget());
...
{
    NuwaCoinGUI* gui = static_cast<NuwaCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<NuwaCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("NuwaCoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your NACs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
