...
/* NuwaCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "NuwaCoin"
#define QAPP_ORG_DOMAIN "nuwacoin.org"
#define QAPP_APP_NAME_DEFAULT "NuwaCoin-Qt"
#define QAPP_APP_NAME_TESTNET "NuwaCoin-Qt-testnet"
