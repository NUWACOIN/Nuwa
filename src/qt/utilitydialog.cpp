...
#include "qt/nuwacoin/qtutils.cpp"
                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("N\u00FCwa Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About N\u00FCwa Coin"));
        ...
        QString header = tr("Usage:") + "\n" +
                         "  N\u00FCwa Coin-qt [" + tr("command-line options") + "]                     " + "\n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("NuwaCoin is shutting down...") + "<br /><br />" +
