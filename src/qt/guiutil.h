...
/** Utility functions used by the NuwaCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render NuwaCoin addresses in monospace font
...
// Parse "nuwacoin:" URI into recipient object, return true on successful parsing
