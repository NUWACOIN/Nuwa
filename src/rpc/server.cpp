...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop NuwaCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "NuwaCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NuwaCoin features */
        {"nuwacoin", "listmasternodes", &listmasternodes, true },
        {"nuwacoin", "getmasternodecount", &getmasternodecount, true },
        {"nuwacoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"nuwacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"nuwacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"nuwacoin", "masternodecurrent", &masternodecurrent, true },
        {"nuwacoin", "startmasternode", &startmasternode, true },
        {"nuwacoin", "createmasternodekey", &createmasternodekey, true },
        {"nuwacoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"nuwacoin", "listmasternodeconf", &listmasternodeconf, true },
        {"nuwacoin", "getmasternodestatus", &getmasternodestatus, true },
        {"nuwacoin", "getmasternodewinners", &getmasternodewinners, true },
        {"nuwacoin", "getmasternodescores", &getmasternodescores, true },
        {"nuwacoin", "preparebudget", &preparebudget, true },
        {"nuwacoin", "submitbudget", &submitbudget, true },
        {"nuwacoin", "mnbudgetvote", &mnbudgetvote, true },
        {"nuwacoin", "getbudgetvotes", &getbudgetvotes, true },
        {"nuwacoin", "getnextsuperblock", &getnextsuperblock, true },
        {"nuwacoin", "getbudgetprojection", &getbudgetprojection, true },
        {"nuwacoin", "getbudgetinfo", &getbudgetinfo, true },
        {"nuwacoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"nuwacoin", "mnfinalbudget", &mnfinalbudget, true },
        {"nuwacoin", "checkbudgets", &checkbudgets, true },
        {"nuwacoin", "mnsync", &mnsync, true },
        {"nuwacoin", "spork", &spork, true },
...
{
    return "> nuwacoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7620/\n";
}
