Contributing to NuwaCoin
============================

The NuwaCoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nuwacoin-project/nuwacoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NuwaCoin project, and is not to be
confused with overall NuwaCoin Network Protocol consensus changes.

Whether a pull request is merged into NuwaCoin rests with the project merge
...
Patches that change NuwaCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the NuwaCoin consensus, it must have been
...
The project leader is the release manager for each NuwaCoin release.
